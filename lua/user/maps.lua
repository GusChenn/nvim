...
-- Navigation
vim_keymap("", "<A-k>", ":wincmd k<cr>", opts)
vim_keymap("", "<A-h>", ":wincmd h<cr>", opts)
vim_keymap("", "<A-j>", ":wincmd j<cr>", opts)
vim_keymap("", "<A-l>", ":wincmd l<cr>", opts)
vim_keymap("t", "<A-k>", "<cmd>wincmd k<cr>", opts)
vim_keymap("t", "<A-h>", "<cmd>wincmd h<cr>", opts)
vim_keymap("t", "<A-j>", "<cmd>wincmd j<cr>", opts)
vim_keymap("t", "<A-l>", "<cmd>wincmd l<cr>", opts)
